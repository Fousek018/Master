...
class adr(Form):
    jmeno = TextField('Jmeno', validators=[
        Predicate(safe_characters, message="Pouzivejte pouze pismena"),
    ...
    ulice = TextField('Ulice', validators=[InputRequired(message="Vyzadovano")])
    mesto = TextField('Mesto', validators=[InputRequired(message="Vyzadovano")])
    psc = IntegerField('PSC', validators=[InputRequired(message="Vyzadovano")])
